 ...
 *  Port:8080
 *  Resources: Endpoints (/getaccesstoken, /publish)
 *  Providers: Validation filters and exceptions
 *  Refer InjectResourcesUtils for details
 */
public class WebServer {
	...
	public static void main(String[] args) throws Exception {
		...
		ServletHolder servletHolder = new ServletHolder(
				new ServletContainer(InjectResourcesUtils.injectResources()));
