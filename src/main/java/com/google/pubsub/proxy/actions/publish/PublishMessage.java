...
public class PublishMessage {
	 ...
	 * data is captured in Request POJO. For the passed message format, please refer com.google.pubsub.proxy.entities.Request
	 * 
	 * @param message
	 * @return
	 * @throws Exception
	...
	public Response doPost(Request req) throws Exception {
		...
		// waiting for what happens downstream. Failed messages are captured in a BQ sink for a postmortem
	...
	/**
	 * A long living publisher object needed. Creating new publisher on 
	 * each request would be extremely expensive resulting in performance 
	 * degradation and resource overhead
	 * 
	 * @param topic
	 * @return
	 * @throws Exception
